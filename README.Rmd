...
The goal of {skmisc} is to gather a set of utility functions I frequently rely on in 
my own workflows. These helpers streamline common tasks and may also be useful in your 
projects. See the [full function references](https://shafayetshafee.github.io/skmisc/reference/index.html).
