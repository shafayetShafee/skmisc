...
Conduct](https://github.com/shafayetShafee/skmisc/blob/main/CODE_OF_CONDUCT.md).
...
[Issues](https://github.com/shafayetShafee/skmisc/issues) that might
...
- Open a new
  [Issue](https://github.com/shafayetShafee/skmisc/issues/new).
- Use the template
  [other_issue.md](https://github.com/shafayetShafee/skmisc/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/shafayetShafee/skmisc/issues?q=label%3Abug).

### How do I submit a bug report?

We use [GitHub Issues](https://github.com/shafayetShafee/skmisc/issues)
to track bugs and errors. If you run into an issue with the project:

- Open a new
  [Issue](https://github.com/shafayetShafee/skmisc/issues/new).
- Use the template
  [bug_report.md](https://github.com/shafayetShafee/skmisc/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
Issues](https://github.com/shafayetShafee/skmisc/issues).

- Open a new
  [Issue](https://github.com/shafayetShafee/skmisc/issues/new).
- Use the template
  [feature_request.md](https://github.com/shafayetShafee/skmisc/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
...
7.  Submit a [Pull
    ...
    on the [original
    repo](https://github.com/shafayetShafee/skmisc/compare).
