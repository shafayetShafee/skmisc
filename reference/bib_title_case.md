...
#> ! Expected a single, non-NA character string; using empty string instead
#> ✔ Successfully wrote BibTeX file: /tmp/RtmpF9X6rx/file184b32e86c6e.bib
...
#> ✔ Successfully wrote BibTeX file: /tmp/RtmpF9X6rx/file184b79527e0e.bib
...
#> ! Invalid journal string: NA in the bib file
#> ! Expected a single, non-NA character string; using empty string instead
#> ✔ Successfully wrote BibTeX file: /tmp/RtmpF9X6rx/file184b69e84dca.bib
```
